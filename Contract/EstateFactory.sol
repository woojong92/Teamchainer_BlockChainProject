...
contract ERC721Metadata is ERC721Basic {
    ...
    */
    ...
    function name() external view returns (string memory _name); // 이름
    function symbol() external view returns (string memory _symbol); // 심볼
...
contract ERC721Token is ERC721, ERC721BasicToken {
    ...
    */
    constructor(string memory _name, string memory _symbol) public { // 생성자
        name_ = _name;
        symbol_ = _symbol;
    }
    ...
    */
    function name() external view returns (string memory) { // name 함수
        return name_;
    }
    ...
    */
    function symbol() external view returns (string memory) { // 심볼 함수
        return symbol_;
    }
    ...
    */
    function tokenOfOwnerByIndex(
        ...
        returns (uint256)
    {
        require(_index < balanceOf(_owner)); // _owner 가 소유한 개수 몇 개 인지 체크
...
contract EstateFactory is Token721 {
    ...
    function getEstatesByOwner(address _owner) public view returns(uint[] memory){
